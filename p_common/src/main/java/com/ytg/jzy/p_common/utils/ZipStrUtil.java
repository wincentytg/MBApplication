...
//				+ "LLppppppppppppppppppppppppppppppppppppppppp===========================------------------------------iiiiiiiiiiiiiiiiiiiiiii";
		String str = FileUtil.readTxtFile("C:\\Users\\dodo\\Desktop\\新建文本文档.txt");
//		System.out.println("\n原始的字符串为------->" + str);
...
//		System.out.println("\n压缩后的字符串为----->" + ys);
		String base64Encoder = Encrypt.base64Encoder(ys);
		System.out.println("base64Encoder==>>"+base64Encoder);
		FileUtil.writeFile("C:\\Users\\dodo\\Desktop\\base64.txt", base64Encoder, false, false);
		System.out.println(""+base64Encoder.length());
		float len1 = ys.length();
		System.out.println("压缩后的字符串长度为----->" + len1);

		ys = Encrypt.base64Decoder(base64Encoder);
