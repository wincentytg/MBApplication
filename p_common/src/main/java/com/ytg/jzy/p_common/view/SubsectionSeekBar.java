...
public class SubsectionSeekBar extends LinearLayout {
    ...
    public SubsectionSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        progress = array.getInteger(R.styleable.SubsectionSeekBar_progressvalue, DEFAULT_PROGRESS);
...
//        }
    ...
    private void refreshWebViewUI(int selectIndex) {
        switch (selectIndex) {
//            case 0:
