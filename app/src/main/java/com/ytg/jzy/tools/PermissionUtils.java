...
public class PermissionUtils {
    ...
    public static void requestPermission(final Activity activity, final int requestCode, PermissionGrant permissionGrant) {
        ...
        if (requestCode < 0 || requestCode >= per.length) {
            Log.w(TAG, "requestPermission illegal requestCode:" + requestCode);
            return;
        }

        final String requestPermission = per[requestCode];
...
//        }
        ...
        if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(activity, "opened:" + per[requestCode], Toast.LENGTH_SHORT).show();
            permissionGrant.onPermissionGranted(requestCode);
        }
    }
...
//                    .show();
            ...
            openSettingActivity(activity, "mro移动应用需要拍照，储存权限，否则不能正常使用，打开方式-确定-权限管理");
        }
...
//        } 
    ...
    private static void shouldShowRationale(final Activity activity, final int requestCode, final String requestPermission) {
        ...
        showMessageOKCancel(activity, "Rationale: " + permissionsHint[requestCode], new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
    ...
    private static void showMessageOKCancel(final Activity context, String message, OnClickListener okListener) {
    ...
    public static void openSettingActivity(final Activity activity, String message) {
        ...
        showMessageOKCancel(activity, message, new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ...
                intent.setData(uri);
                activity.startActivityForResult(intent, 0x1101);
            }
        });
    }
    ...
    public static ArrayList<String> getNoGrantedPermission(Activity activity, boolean isShouldRationale) {
        ...
        ArrayList<String> permissions = new ArrayList<>();
          per =getRequestPermisstion(activity);
        for (int i = 0; i <per.length; i++) {
            String requestPermission = per[i];
...
//            }
     ...
     */
     public static String[]getAppPermission(Activity act){
    	 try {
			permission = act.getPackageManager().getPackageInfo(act.getPackageName(), PackageManager.GET_PERMISSIONS).requestedPermissions;
     ...
     static String[] getRequestPermisstion(Activity act){
    	 ...
    	 permission = getAppPermission(act);
